...
jump_fx = pygame.mixer.Sound('audio_jump.wav')
jump_fx.set_volume(0.05)
shot_fx = pygame.mixer.Sound('audio_shot.wav')
shot_fx.set_volume(0.05)
grenade_fx = pygame.mixer.Sound('audio_grenade.wav')
...
class Soldier(pygame.sprite.Sprite):
    def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
        ...
        for animation in animation_types:
            ...
            num_of_frames = len(os.listdir(f'{self.char_type}_{animation}'))
            for i in range(num_of_frames):
                img = pygame.image.load(f'{self.char_type}_{animation}_{i}.png').convert_alpha()
...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, x, y, scale):
        ...
        for num in range(1, 6):
            img = pygame.image.load(f'exp4.png').convert_alpha()
            img = pygame.transform.scale(img, (int(img.get_width() * scale), int(img.get_height() * scale)))
